...
var templates = {
    'default': {'verbose': 'Default Note', 'icon': 'file', 'short': 'DEFAULT'},
    'cornell': {'verbose': 'Cornell Template', 'icon': 'file-alt', 'short': 'CORNELL'},
    'matrix': {'verbose': 'Matrix Template', 'icon': 'file-invoice', 'short': 'MATRIX'},
};
